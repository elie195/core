...
=======
    "Share via email. Opens your mail client." : "Partilhar através de e-mail. Abre o seu cliente de e-mail.",
...
>>>>>>> d17a83eaa52e94ce1451a9dd610bbc812b80f27e
    ...
    "Hey there,\n\njust letting you know that %s shared %s with you.\nView it: %s\n\n" : "Olá,\n\napenas para o informar que %s partilhou %s consigo.\nVer aqui: %s\n",
    ...
    "Please specify the port number along with the host name (e.g., localhost: 5432)." : "Por favor, especifique o número da porta com o nome do hospedeiro (exemplo, localhost: 5432).",
    "Performance warning" : "Aviso de Desempenho",
    "SQLite will be used as database." : "SQLite será utilizado como base de dados.",
    ...
    "An error occurred while verifying the token" : "Ocorreu um erro durante a verificação do código",
