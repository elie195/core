OC.L10N.register(
    ...
    "The new password can not be the same as the previous one" : "Det nye passordet kan ikke være det samme som det forrige",
...
>>>>>>> d17a83eaa52e94ce1451a9dd610bbc812b80f27e
    ...
    "Download logfile (%s)" : "Last ned loggfil (%s)",
    ...
    "Sessions" : "Økter",
    "These are the web, desktop and mobile clients currently logged in to your ownCloud." : "Disse web-, skrivebords- og mobilklientene er pålogget din ownCloud for øyeblikket.",
    "Browser" : "Nettleser",
    "Most recent activity" : "Siste aktivitet",
    "App passwords" : "App-passord",
    "You've linked these apps." : "Du har lenket disse appene.",
    "Name" : "Navn",
    "An app password is a passcode that gives an app or device permissions to access your %s account." : "Et app-passord er et passord som gir en app eller en enhet lov til å bruke %s-kontoen din.",
    "App name" : "App-navn",
    "Create new app password" : "Lag nytt app-passord",
    "Use the credentials below to configure your app or device." : "Bruk detaljene nedenfor til å konfigurere appen eller enheten din.",
    "Username" : "Brukernavn",
    "Done" : "Ferdig",
    "Version" : "Versjon",
    "Personal" : "Personlig",
