...
<<<<<<< HEAD
    ...
    "Your database does not run with \"READ COMMITED\" transaction isolation level. This can cause problems when multiple actions are executed in parallel." : "La to base de datos nun s'executa col nivel d'aislamientu de transacción \"READ COMMITED\". Esto puede causar problemes cuando múltiples acciones s'executen en paralelu.",
...
=======
    ...
    "Forum" : "Foru",
    "Issue tracker" : "Siguidor de problemes",
...
>>>>>>> d17a83eaa52e94ce1451a9dd610bbc812b80f27e
    ...
    "Name" : "Nome",
    "An app password is a passcode that gives an app or device permissions to access your %s account." : "Una contraseña d'aplicación ye un códigu d'accesu que da permisu a una aplicación o dispositivo p'aportar a la so cuenta %s.",
    "App name" : "Nome d'aplicación",
    "Create new app password" : "Crear nueva contraseña d'aplicación",
