OC.L10N.register(
    ...
    "The app will be downloaded from the app store" : "將會從應用程式商店下載應用程式",
    ...
    "App update" : "應用程式更新",
    "Experimental" : "實驗性質",
    "No apps found for {query}" : "沒有應用程式符合 {query}",
    ...
    "Delete" : "刪除",
    "Disconnect" : "中斷連線",
    "Error while loading browser sessions and device tokens" : "載入瀏覽器工作階段和裝置 token 時發生錯誤",
    "Sending..." : "傳送中…",
