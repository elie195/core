OC.L10N.register(
    ...
    "It has been detected that the sample configuration has been copied. This can break your installation and is unsupported. Please read the documentation before performing changes on config.php" : "Foi detectado que a configuração de amostra foi copiada. Isso pode danificar a sua instalação e não é suportado. Por favor, leia a documentação antes de realizar mudanças no ficheiro config.php",
    ...
    "ownCloud %s or higher is required." : "É necessário o ownCloud %s ou superior.",
    "ownCloud %s or lower is required." : "É necessário o ownCloud %s ou inferior.",
    ...
    "Log-in credentials, save in session" : "Credenciais de sessão, guardar na sessão",
    ...
    "4-byte characters are not supported in file names" : "Carateres de 4 bytes não são suportados nos nomes de ficheiro",
    ...
    "No source specified when installing app" : "Não foi especificada uma fonte quando instalava a aplicação",
    ...
    "Failed to open archive when installing app" : "Falhou a abertura do ficheiro quando instalava a aplicação",
    "App does not provide an info.xml file" : "A aplicação não disponibiliza um ficheiro info.xml",
    "App cannot be installed because appinfo file cannot be read." : "A aplicação não pode ser instalada porque o ficheiro appinfo não pode ser lido.",
    "Signature could not get checked. Please contact the app developer and check your admin screen." : "Não foi possível verificar a assinatura. Por favor, contacte o programador da aplicação e verifique o ecrã de administrador.",
    ...
    "Security" : "Segurança",
    "User Authentication" : "Autenticação de Utilizador",
    "Encryption" : "Encriptação",
    "Workflows & Tags" : "Fluxo de Trabalho & Identificadores",
    "Sharing" : "Partilha",
    "Search" : "Procurar",
    ...
    "Can't create or write into the data directory %s" : "Não é possível criar ou escrever na diretoria 'data' %s",
    ...
    "You need to provide a password to create a public link, only protected links are allowed" : "Precisa de fornecer a palavra-passe para criar uma hiperligação pública, só são permitidas hiperligações protegidas",
    ...
    "The username is already being used" : "O nome de utilizador já está a ser utilizado",
    "Login canceled by app" : "Início de sessão cancelada pela aplicação",
...
=======
    "App \"%s\" cannot be installed because the following dependencies are not fulfilled: %s" : "A aplicação \"%s\" não pode ser instalada porque as seguintes dependências não podem ser realizadas: %s",
    "web services under your control" : "serviços da Web sob o seu controlo",
>>>>>>> d17a83eaa52e94ce1451a9dd610bbc812b80f27e
    ...
    "Token expired. Please reload page." : "O código expirou. Por favor, recarregue a página.",
...
=======
    "No database drivers (sqlite, mysql, or postgresql) installed." : "Sem controladores da base de dados (mysql, postgresql ou sqlite) instalados.",
>>>>>>> d17a83eaa52e94ce1451a9dd610bbc812b80f27e
    ...
    "Cannot create \"data\" directory" : "Não é possível criar a diretoria de \"dados\"",
    ...
    "PostgreSQL >= 9 required" : "Requerido PostgreSQL >= 9",
    "Please upgrade your database version" : "Por favor, atualize a sua versão da base de dados",
    "Please change the permissions to 0770 so that the directory cannot be listed by other users." : "Por favor, altere as permissões para 0770, e assim essa diretoria não pode ser listada pelos outros utilizadores.",
    "Your Data directory is readable by other users" : "A sua diretoria 'Data' é legível pelos outros utilizadores",
    "Your Data directory must be an absolute path" : "A sua diretoria 'Data' deve ser um caminho absoluto",
    "Check the value of \"datadirectory\" in your configuration" : "Verifique o valor de \"datadirectory\" na sua configuração",
    "Your Data directory  is invalid" : "A sua diretoria 'Data' é inválida",
    "Please check that the data directory contains a file \".ocdata\" in its root." : "Por favor, verifique se a diretoria 'data' contém um ficheiro \".ocdata\" na sua raiz.",
