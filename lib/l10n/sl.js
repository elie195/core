OC.L10N.register(
    ...
    "Avatar image is not square" : "Sličica podobe uporabnika ni kvadratna",
    "today" : "danes",
    "yesterday" : "včeraj",
    ...
    "Workflows & Tags" : "Potek dela in oznake",
    "Sharing" : "Souporaba",
    "Search" : "Poišči",
    "Updates" : "Posodobitve",
    "Help & Tips" : "Pomoč & Namigi",
    "Additional" : "Dodatno",
    ...
    "Sharing failed, because the user %s is the original sharer" : "Nastavitev souporabe je spodletela, ker je uporabnik %s prvi omogočil souporabo.",
    ...
    "Login canceled by app" : "Program je prijavo prekinil.",
...
>>>>>>> d17a83eaa52e94ce1451a9dd610bbc812b80f27e
    ...
    "This can usually be fixed by <a href=\"%s\" target=\"_blank\" rel=\"noreferrer\">giving the webserver write access to the root directory</a>." : "To se običajno lahko odpravi z <a href=\"%s\" target=\"_blank\" rel=\"noreferrer\">dodelitvijo dovoljenja spletnemu strežniku za pisanje v korenski imenik</a>.",
    ...
    "Adjusting this setting in php.ini will make ownCloud run again" : "Prilagoditev te nastavitve v datoteki php.ini lahko omogoči delovanje oblaka ownCloud.",
    "mbstring.func_overload is set to \"%s\" instead of the expected value \"0\"" : "parameter mbstring.func_overload je nastavljen na \"%s\" namesto pričakovane vrednosti \"0\"",
    "To fix this issue set <code>mbstring.func_overload</code> to <code>0</code> in your php.ini" : "Da bi odpravili to težavo, nastavite <code>mbstring.func_overload</code> na <code>0</code> v datoteki php.ini.",
    "libxml2 2.7.0 is at least required. Currently %s is installed." : "Zahtevana je knjižnica libxml2 2.7.0. Trenutno je nameščena različica %s.",
    ...
    "PHP is apparently set up to strip inline doc blocks. This will make several core apps inaccessible." : "Nastavitve PHP določajo, da so medvrstični bloki besedila odrezani. Ta nastavitev lahko povzroči, da nekateri osnovni moduli ne bodo dosegljivi.",
    "This is probably caused by a cache/accelerator such as Zend OPcache or eAccelerator." : "Napako je najverjetneje povzročil predpomnilniški program oziroma pospeševalnik, kot sta Zend OPcache ali eAccelerator.",
    ...
    "Your Data directory is readable by other users" : "Podatkovna mapa ima določena dovoljenja za branje skupine.",
    "Your Data directory must be an absolute path" : "Podatkovna mapa mora imeti navedeno celotno pot.",
    "Check the value of \"datadirectory\" in your configuration" : "Preverite nastavitev \"datadirectory\"",
