OC.L10N.register(
    ...
    "Workflows & Tags" : "Рабочие процессы и метки",
    "Sharing" : "Общий доступ",
    "Search" : "Найти",
    "Updates" : "Обновления",
    "Help & Tips" : "Помощь и советы",
...
<<<<<<< HEAD
    ...
    "App '%s' could not be installed!" : "Не удалось установить приложение '%s'!",
=======
>>>>>>> d17a83eaa52e94ce1451a9dd610bbc812b80f27e
    ...
    "Cannot create \"data\" directory" : "Не могу создать каталог \"data\"",
    ...
    "Your Data directory is readable by other users" : "Ваш каталог данных доступен на чтение для других пользователей",
    "Your Data directory must be an absolute path" : "Путь к каталогу данных должен быть абсолютным",
    "Check the value of \"datadirectory\" in your configuration" : "Проверьте значение \"datadirectory\" в настройках.",
    "Your Data directory  is invalid" : "Ваш каталог данных неверен",
