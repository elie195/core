OC.L10N.register(
    ...
    "This can usually be fixed by giving the webserver write access to the config directory" : "בדרך כלל ניתן לפתור את הבעיה על ידי כך שנותנים ל- webserver הרשאות כניסה לתיקיית config",
    "See %s" : "ניתן לראות %s",
    ...
    "Avatar image is not square" : "תמונת דמות מייצגת, אווטאר, אינה ריבועית",
    "today" : "היום",
    "yesterday" : "אתמול",
    ...
    "Storage" : "אחסון",
    "Security" : "אבטחה",
    "User Authentication" : "אימות משתמש",
    "Encryption" : "הצפנה",
...
<<<<<<< HEAD
    ...
    "App '%s' could not be installed!" : "לא ניתן היה להתקין יישום '%s'!",
=======
>>>>>>> d17a83eaa52e94ce1451a9dd610bbc812b80f27e
    ...
    "Your Data directory is readable by other users" : "תיקיית Data שלך ניתנת לקריאה על ידי משתמשים אחרים",
    "Your Data directory must be an absolute path" : "תיקיית Data שלך חייבת להיות כנתיב אבסולוטי",
    "Check the value of \"datadirectory\" in your configuration" : "יש לבדוק את הערך \"datadirectory\" בהגדרות התצורה שלך",
    "Your Data directory  is invalid" : "תיקיית Data שלך אינה חוקית",
